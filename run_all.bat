@echo off
TITLE NeuroDetect Lab - Launcher
COLOR 0B

echo ==========================================
echo       LANCEMENT DE NEURODETECT LAB
echo ==========================================
echo.

:: 1. Lancement du Service ML (Python)
echo [1/3] Demarrage du Service ML (Port 5001)...
start "NeuroDetect - ML Service" cmd /k "cd ml_service && .venv\Scripts\activate && python app.py"
...
start "NeuroDetect - Backend" cmd /k "cd backend && npm run dev"
...
start "NeuroDetect - Frontend" cmd /k "cd neuro-detect-lab-main && npm run dev"
