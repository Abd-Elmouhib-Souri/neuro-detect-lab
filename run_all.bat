@echo off
TITLE DataScoop - Launcher
COLOR 0B

echo ==========================================
echo       LANCEMENT DE DATASCOOP
echo ==========================================
echo.

:: 1. Lancement du Service ML (Python)
echo [1/3] Demarrage du Service ML (Port 5001)...
start "DataScoop - ML Service" cmd /k "cd ml_service && .venv\Scripts\activate && python app.py"
...
start "DataScoop - Backend" cmd /k "cd backend && npm run dev"
...
start "DataScoop - Frontend" cmd /k "cd neuro-detect-lab-main && npm run dev"
